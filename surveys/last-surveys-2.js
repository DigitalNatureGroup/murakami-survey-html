// 最終サーベイ2：体験全体の振り返り
export const lastSurvey2 = {
    id: "last-survey-2",
    title: "最終アンケート2",
    title_en: "Final Survey 2",
    ...
    questions: [
      ...
      { 
        ...
        note: "各手法で作成した作品の評価について教えてください。",
        note_en: "Please tell us about the evaluation of works created with each method."
      },
      {
        id: "q0_best_work",
        type: "radio",
        label: "🐬 イルカ, 🐎 ウマ, 🐤 ヒヨコで作った作品で一番良いと思ったものを選んでください。",
        label_en: "Please select the best work you think among the works created with 🐬 Dolphin, 🐎 Horse, and 🐤 Chick.",
        required: true,
        options: [
      ...
      {
        id: "q0_best_work_reason",
        type: "text",
        label: "一番良いと思った理由について教えてください。悪いと思った作品もあれば記入してください。",
        label_en: "Please tell us the reason why you think it's the best. If there are any works you think are bad, please also write about them.",
        required: true
      },
      { 
        id: "sec_intro", 
      ...
      // 1. 導入と全体比較
      {
        id: "q1_best_method",
        type: "radio",
        label: "3つの手法（🐬 イルカ, 🐎 ウマ, 🐤 ヒヨコ）の中で、最も使いやすかったのはどれですか？",
        label_en: "Among the three methods (🐬 Dolphin, 🐎 Horse, 🐤 Chick), which was the most user-friendly?",
        required: true,
        options: [
          { value: "glv-bo", label: "🐬 イルカ", label_en: "🐬 Dolphin" },
          { value: "standard-bo", label: "🐎 ウマ", label_en: "🐎 Horse" },
